...
/* harmony import */ var html5sortable_dist_html5sortable_es_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! html5sortable/dist/html5sortable.es.js */ "./node_modules/html5sortable/dist/html5sortable.es.js");
...
var DraggableInputs = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(DraggableInputs, [{
    key: "start",
    value: function start() {
      ...
      this.output = this.outputSelector ? document.querySelector(this.outputSelector) : null;
      this.getElements();
      this.addListeners();
    }
  }, {
    ...
    value: function getElements() {
      this.elements = this.elSelector ? document.querySelectorAll(this.elSelector) : [];
    }
  }, {
    key: "startSortable",
    value: function startSortable() {
      this.sortable = Object(html5sortable_dist_html5sortable_es_js__WEBPACK_IMPORTED_MODULE_2__["default"])(this.sortableSelector, this.sortableOptions)[0];
    }
  }, {
    key: "addListeners",
    value: function addListeners() {
    ...
    key: "setError",
    value: function setError(input) {
      input.classList.add("invalid");
      input.parentNode.querySelector(".validation-status").textContent = this.errorMessage;
    }
  }, {
    key: "setOk",
    value: function setOk(input) {
      input.classList.remove("invalid");
      input.parentNode.querySelector(".validation-status").textContent = "";
    }
  }, {
    key: "onSubmit",
    value: function onSubmit(input, el) {
      if (input.value) {
    ...
    key: "moveUp",
    value: function moveUp(input, el) {
      Array.prototype.slice.call(this.elements).find(function (empty) {
        return empty.getAttribute("data-contains-setting") > input.getAttribute("data-setting");
      });
      var notEmpties = Array.prototype.slice.call(this.elements).filter(function (el) {
    ...
    key: "reset",
    value: function reset(input, el) {
      el.classList.remove("not-empty");
      var firstAfter = Array.prototype.slice.call(this.elements).filter(function (el) {
        return !el.classList.contains("not-empty");
      }).find(function (empty) {
        return empty.getAttribute("data-contains-setting") > input.getAttribute("data-setting");
      });
